<?php $fields = $this->session->userdata('form_valid'); ?>
<div class="row margin-lg">
    <div class="col-md-8 col-md-offset-2">
        <div class="text-center">
            <h2 class="fadeInUp animation-delay10" style="font-weight:bold;">
                <span class="text-primary"><?=$system_title['company']?></span> <span style="color:#ccc; text-shadow:0 1px #fff"><?=$system_title['register']?></span>
            </h2>
        </div>
        <div class="login-widget animation-delay1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?=form_open(base_url($lang.'/action/register/2'),'class="form-horizontal" method="post" enctype="multipart/form-data"')?>
                    <?php
                        ...
                        $this->load->view('register/templates/tractor_info');
                        $this->load->view('register/templates/trailer_info');
                    ?>
                    <hr>
