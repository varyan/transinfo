<div class="form-group">
    ...
    <div class="col-md-9">
        <input value="<?=(isset($fields['username'])) ? $fields['username'] : '' ;?>" type="text" name="username" class="form-control input-sm bounceIn animation-delay1">
    </div>
</div><!-- /form-group -->
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-md-9">
        <input value="" type="password" name="confirm" class="form-control input-sm bounceIn animation-delay3">
    </div>
</div><!-- /form-group -->