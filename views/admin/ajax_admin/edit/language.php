<?php $language = $admin_get_where('languages',['id'=>$id])[0]; ?>

<div class="panel panel-default well-lg">
    <form method="post" enctype="multipart/form-data" action="<?=base_url()?>action/update/languages/<?=$language->id?>" class="form-horizontal form-border">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input value="<?=$language->short_name?>" type="text" class="form-control input-sm" name="short_name">
                </div><!-- /.col -->
            </div><!-- /form-group -->
            <div class="form-group">
                <label class="control-label col-md-2">Original Name</label>
                <div class="col-md-10">
                    <input value="<?=$language->original_name?>" type="text" class="form-control input-sm" name="original_name">
                </div><!-- /.col -->
            </div><!-- /form-group -->
            <div class="form-group">
                <label class="control-label col-md-2">Name in english</label>
                <div class="col-md-10">
                    <input value="<?=$language->name?>" type="text" class="form-control input-sm" name="name">
                </div><!-- /.col -->
            </div><!-- /form-group -->
            <div class="form-group">
                ...
                <div class="col-md-1"><?=$language->file?></div>
                <div class="col-md-1">
